            ...
            <div className={styles.section_content}>
                <div className={styles.section_content_left}>
                    ...
                    <section className={styles.section_content_left_buttons}>
                        <Button content='See our services' width='315px' backgroundColor='#536EF3' fontColor='#F8F8F8' backgroundColorHover='#3A4CA5' fontColorHover='#F8F8F8'/>

                        <Button content='Contact us' width='315px' backgroundColor='transparent' fontColor='#080C23' backgroundColorHover='#080C23' fontColorHover='#F8F8F8'
